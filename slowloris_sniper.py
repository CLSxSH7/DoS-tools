...
# modo de uso no terminal > python3 slowloris_sniper.py <IP> -p <porta> -s 200 / 200 sockets = quantidade ideal de sockets para não gerar muitos ruídos no lado de quem recebe o ataque
